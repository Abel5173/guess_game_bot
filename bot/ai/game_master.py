...
class AIGameMaster:
    ...
    def __init__(self):
        ...
        self.station_names = [
            "Nebula Prime", "Stellar Outpost", "Void Station", "Cosmic Hub",
            "Quantum Nexus", "Stellar Gateway", "Void Frontier", "Nebula Station",
            "Cosmic Outpost", "Quantum Hub", "Stellar Nexus", "Void Gateway"
        ]
    ...
    async def start_game_session(self, 
                               game_id: str,
                               players: List[Dict],
                               game_type: str = "standard") -> Dict[str, Any]:
        ...
        try:
            ...
            # Log game start
            self._log_game_event(game_id, "game_started", {
    ...
    async def assign_roles_with_narrative(self, 
                                        game_id: str,
    ...
    async def generate_round_narrative(self, 
                                     game_id: str,
                                     round_number: int,
                                     alive_players: List[str],
                                     dead_players: List[str]) -> str:
        ...
        try:
            ...
            # Log round start
            self._log_game_event(game_id, "round_started", {
                "round": round_number,
...
Make it suspenseful and engaging."""
    ...
    async def generate_voting_narrative(self, 
                                      game_id: str,
                                      votes: Dict[str, str],
                                      ejected_player: str,
...
Make it cinematic and emotional."""
            ...
            # Log voting event
            self._log_game_event(game_id, "player_ejected", {
                "ejected_player": ejected_player,
                "round": round_number,
                "votes": votes
            })
            
            return f"🗳️ **Voting Results**\n\n{narrative}\n\n🤔 **AI Analysis**\n{analysis}"
    ...
    async def generate_chaos_event(self, 
                                 game_id: str,
                                 trigger: str = "random") -> Optional[Dict[str, str]]:
        ...
        try:
            ...
            game_state = f"Round {len(session['rounds']) + 1}, {len(session['players'])} players"
...
Make it epic and memorable."""
            ...
            # Log game end
            self._log_game_event(game_id, "game_ended", {
                "winner": winner,
    ...
    def _get_fallback_session(self, game_id: str, players: List[Dict], game_type: str) -> Dict[str, Any]:
