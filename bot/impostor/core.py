...
class ImpostorCore:
    ...
    def __init__(self, config: Optional[dict] = None):
        self.players: Dict[int, dict] = {}  # user_id: {'name': name, 'alive': True}
    ...
    def check_game_over(self):
        impostors_alive = len([uid for uid in self.players if uid in self.impostors and self.players[uid]['alive']])
        crewmates_alive = len([uid for uid in self.players if uid not in self.impostors and self.players[uid]['alive']])
