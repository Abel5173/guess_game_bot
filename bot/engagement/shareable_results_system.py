...
class ShareableResultsSystem:
    ...
    def create_shareable_result(self, player_id: int, game_id: str, 
    ...
    def _generate_share_message(self, player: Player, game_result: Dict, 
                              result_type: str, result_id: str) -> str:
        """Generate a shareable message."""
        # Select random template
        templates = self.sharing_templates.get(result_type, self.sharing_templates["crewmate_win"])
    ...
    def share_result(self, result_id: str, share_method: str = "telegram") -> Tuple[bool, str]:
