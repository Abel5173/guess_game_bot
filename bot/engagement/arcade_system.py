...
class ArcadeSystem:
    ...
    def start_arcade_game(self, session_id: int, game_type: ArcadeGameType = None) -> Dict:
    ...
    def submit_answer(self, session_id: int, player_id: int, answer: str) -> Tuple[bool, str]:
    ...
    def end_arcade_game(self, session_id: int) -> Dict:
        ...
        logger.info(f"Ended arcade game in session {session_id}: {len(game['winners'])} winners")
    ...
    def _check_answer(self, game_type: ArcadeGameType, player_answer: str, correct_answer: str) -> bool:
    ...
    def _award_arcade_xp(self, player_id: int, xp_amount: int):
        ...
        try:
            ...
            if player:
                player.xp += xp_amount
                db.commit()
                logger.info(f"Player {player_id} earned {xp_amount} XP from arcade game")
