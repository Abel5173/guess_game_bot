...
class Reward:
    ...
    def __init__(self, reward_type: RewardType, value: int, description: str, rarity: str):
...
class CrateSystem:
    ...
    def _generate_reward(self, reward_type: RewardType, crate_type: CrateType) -> Reward:
